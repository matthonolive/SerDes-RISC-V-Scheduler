...
/* ── QEMU virt 16550 UART at 0x10000000 ───────────────────── */
#define UART_BASE    0x10000000
#define UART_THR     (*(volatile uint8_t *)(UART_BASE + 0))  /* TX holding  */
...
/* ═══════════════════════════════════════════════════════════════
 * Driver task — runs all phases, prints results.
 * ═══════════════════════════════════════════════════════════════ */
void driver_task(void) {

    print("\n=== Scheduler cycle-count benchmark (QEMU) ===\n");
    print("NOTE: with -icount shift=0, mcycle = instruction count\n\n");
    ...
    if (pre_count == 0) {
        ...
        print("    (timer.S interval is 90M mtime ticks — probe\n");
        print("     window may be too short.  Try increasing\n");
        print("     PREEMPT_SAMPLES or decreasing TIMER_INTERVAL.)\n");
    } else {
